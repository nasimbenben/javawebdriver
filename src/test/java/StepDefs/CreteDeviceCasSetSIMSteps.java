...
public class CreteDeviceCasSetSIMSteps {
    ...
    public void beforeMethod() {
        ...
        driver.get("https://enexistst.energyict.com/apps/multisense/index.html");
    ...
    public void i_want_to_change_the_information_i_click_on_Edit_under_the_button(String subButton,String button) throws Throwable {
        ...
        this.dashBoardPage.waitAndClickOnElement(this.dashBoardPage.deviceAttributesActionButton(subButton));
    }
    ...
    public void i_Change_the_Values_from_old_value_to_new_value(DataTable content) throws Throwable {
        ...
        for (Map<String, String> data : content.asMaps(String.class, String.class)) {
            ...
            this.dashBoardPage.waitAndTypeInField(this.dashBoardPage.detailField(data.get("Object")), data.get("Value"));
        }
    ...
    public void i_verify_if_the_atttributes_has_the_correct_values(DataTable verifyElements) throws Throwable {
        ...
        for (Map<String, String> data : verifyElements.asMaps(String.class, String.class)) {
            ...
            this.dashBoardPage.verifySingleElements(this.dashBoardPage.deviceAttributesMultipleElement(data.get("Object"),data.get("Object")), data.get("Value"));
